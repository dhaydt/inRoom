...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode']], function () {
    ...
    Route::get('searched-products_mobile', 'WebController@searched_products_mobile')->name('searched-products_mobile');
    ...
    Route::post('order-cancel', 'UserProfileController@order_cancel')->name('order-cancel');
