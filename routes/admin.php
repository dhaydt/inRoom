...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('/province', 'AddressController@province')->name('prov');
    Route::get('/city/{id}', 'AddressController@city')->name('city');
    Route::get('/district/{id}', 'AddressController@district')->name('district');
    Route::get('/getApplied', [DashboardController::class, 'getApplied'])->name('getApplied');
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'deal', 'as' => 'deal.', 'middleware' => ['module:marketing_section']], function () {
            ...
            Route::post('poin-update', 'DealController@poinUpdate')->name('poin-update');
            Route::get('poin-delete/{id}', 'DealController@poinDelete')->name('poin-delete');
        ...
        Route::group(['prefix' => 'property', 'as' => 'property.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::post('new-property', 'KostAdminController@store')->name('store');
            Route::get('edit-property/{id}', 'KostAdminController@edit')->name('edit');
            Route::post('update-property/{id}', 'KostAdminController@update')->name('update');
            Route::delete('delete/{id}', 'KostAdminController@destroy')->name('delete');
        });
