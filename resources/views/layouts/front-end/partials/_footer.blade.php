        ...
        <div
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <ul class="widget-list" style="padding-bottom: 10px">
                        ...
                        <li class="widget-list-item">
                            <a class="widget-list-link"
                               href="{{route('flash-deals',[$flash_deals['id']])}}">
                                {{\App\CPU\translate('flash_deal_room')}}
                            </a>
                        </li>
                    @endif
                    ...
                    {{-- <li class="widget-list-item"><a class="widget-list-link"
                                                    href="{{route('products',['data_from'=>'latest','page'=>1])}}">{{\App\CPU\translate('latest_rooms')}}</a>
                    </li> --}}
                    {{-- <li class="widget-list-item"><a class="widget-list-link"
                                                    href="{{route('products',['data_from'=>'best-selling','page'=>1])}}">{{\App\CPU\translate('best_selling_room')}}</a>
                    </li> --}}
                    <li class="widget-list-item"><a class="widget-list-link"
                                                    href="{{route('products',['data_from'=>'top-rated','page'=>1])}}">{{\App\CPU\translate('top_rated_room')}}</a>
                    </li>
            ...
            <!-- Grid column -->
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{\App\CPU\translate('account_&_booking_info')}}</h6>
                @if(auth('customer')->check())
                    <ul class="widget-list" style="padding-bottom: 10px">
                        ...
                        <li class="widget-list-item"><a class="widget-list-link"
                                                        href="{{route('wishlists')}}">{{\App\CPU\translate('favorite')}}</a>
                        </li>
                        {{--<li class="widget-list-item">
                            <a class="widget-list-link"
                        ...
                        <li class="widget-list-item"><a class="widget-list-link"
                                                        href="{{route('track-order.index')}}">{{\App\CPU\translate('my_kost')}}</a>
                        </li>
                        {{-- <li class="widget-list-item"><a class="widget-list-link"
                ...
                @else
                    <ul class="widget-list" style="padding-bottom: 10px">
                        ...
                        <li class="widget-list-item"><a class="widget-list-link"
                                                        href="{{url('wishlists')}}">{{\App\CPU\translate('favorite')}}</a>
                        </li>
                        {{--<li class="widget-list-item">
                            <a class="widget-list-link"
                               href="{{route('customer.auth.login')}}">{{\App\CPU\translate('chat_with_seller_s')}}
                        ...
                        <li class="widget-list-item"><a class="widget-list-link"
                                                        href="{{url('account-kost')}}">{{\App\CPU\translate('my_kost')}}</a>
                        </li>
                        {{-- <li class="widget-list-item"><a class="widget-list-link"
