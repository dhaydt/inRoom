                ...
                <div class="navbar-vertical-content mt-2">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('order_management'))
                            <li class="nav-item {{Request::is('admin/orders*')?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{\App\CPU\translate('Jobs_vacancy')}}</small>
                    ...
                    <!--order management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            <li class="nav-item {{(Request::is('admin/brand*') || Request::is('admin/category*') || Request::is('admin/property*') || Request::is('admin/sub*') || Request::is('admin/attribute*') || Request::is('admin/product*'))?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{\App\CPU\translate('property_management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/product/list/in_house') ||Request::is('admin/property/list/in_house') || Request::is('admin/product/edit/*') || (Request::is('admin/property/edit-property/*')) || Request::is('admin/product/bulk-import'))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-shop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{\App\CPU\translate('InHouse_property')}}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/property/list/in_house') || (Request::is('admin/property/edit-property/*')) ?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.property.list',['in_house', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Property')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/product/list/in_house') || Request::is('admin/product/edit/*') ?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.list',['in_house', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Rooms')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/product/list/seller*') || Request::is('admin/property/list/seller*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-airdrop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Property')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/property/list/seller')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.property.list',['seller', 'status'=>'0'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Properties')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/product/list/seller?status=0')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.list',['seller', 'status'=>'0'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('New')}} {{\App\CPU\translate('Rooms')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/product/list/seller/1')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.list',['seller', 'status'=>'1'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Approved')}} {{\App\CPU\translate('Rooms')}}</span>
                                        </a>
                                    </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/jobs*') ?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/jobs/list/in_house') ? 'block':'' }}">
                                    <li class="nav-item {{Request::is('admin/jobs/list/in_house') ?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.jobs.list',['in_house', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('InRoom_jobs')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/jobs/list/seller') || Request::is('admin/jobs/edit/*') ?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.jobs.list',['seller', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
...
{{--                            </li>--}}
                    ...
                    <!--business settings ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('web_&_app_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/article')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.article.index')}}">
                                    <i class="fa fa-newspaper-o nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Article_config')}}
                                    </span>
                                </a>
                            </li>
