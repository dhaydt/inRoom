...
<div class="content container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a
                    href="{{route('admin.jobs.list', ['type' => 'all'])}}">{{\App\CPU\translate('Jobs')}}</a>
            </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="product-form" action="{{route('admin.jobs.update',$product->id)}}" method="post"
...
<script>
    function check(){
            ...
            $.post({
                url: '{{route('admin.jobs.update',$product->id)}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
