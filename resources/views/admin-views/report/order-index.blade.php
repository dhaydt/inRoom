                           ...
                           "scales": {
                              "yAxes": [{
                                ...
                                "ticks": {
                                  ...
                                  "stepSize": {{round(\App\CPU\BackEndHelper::max_orders()/5)}},
                                  "fontColor": "#97a4af",
                                        ...
                                        <div class="card-body py-0">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        {{\App\CPU\translate('Orders')}}  {{str_replace('_',' ',$order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    ...
                                                    <div class="text-capitalize">
                                                        {{\App\CPU\translate('Status')}} <strong> : {{ str_replace('_',' ',$order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
