...
@foreach ($combinations as $key => $combination)
	...
	@if(strlen($str) > 0)
			<tr>
				...
				{{-- <td> --}}
					<input type="hiddden" name="sku_{{ $str }}" value="{{ $sku }}" class="form-control" required>
				{{-- </td> --}}
				{{-- <td> --}}
					<input type="hiddden" name="qty_{{ $str }}" value="1" min="0" max="100000" step="1" class="form-control" required>
				{{-- </td> --}}
			</tr>
	@endif
@endforeach
