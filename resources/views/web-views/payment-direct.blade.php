                        ...
                        <div class=" p-5">
                            <div class="row">
                                ...
                                <div class="col-12 mt-4">
                                    <h5 style="font-size: 20px; font-weight: 700">{{\App\CPU\translate('Metode_pembayaran_langsung_dipilih!')}}
                                        !</h5>
                                </div>
                            </div>
                            ...
                            <span>{{\App\CPU\translate('Silahkan_melakukan_pembayaran_langsung ditempat!!!')}}</span>
