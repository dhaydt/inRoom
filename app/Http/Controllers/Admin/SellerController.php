...
class SellerController extends Controller
{
    ...
    public function updateStatus(Request $request)
    {
        ...
        if ($request->status == 'approved') {
            $fcm_token = $order->cm_firebase_token;

            $data = [
                'title' => 'Your Registration Approved',
                'description' => 'Your registration was accepted by admin',
            ];
            ...
            $data = [
                ...
                'description' => 'Your registration was denied by admin',
            ];
            Helpers::send_push_notif_to_device($fcm_token, $data);
            ...
            $data = [
                ...
                'description' => 'Your registration was suspended by admin',
            ];
            Helpers::send_push_notif_to_device($fcm_token, $data);
